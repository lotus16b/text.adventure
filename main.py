...
if(pillChoice == "blue pill"):
    ...
    print("...and awake...feeling as if you are in motion, no longer in the Starlite Starbright trailer park")
elif(pillChoice == "red pill"):
    print("You take the red pill and...feel no change...the arcade cabinet sits before you. You remain stuck in the Starlite Starbright trailer park wishing you could do something with your life besides fixing Elvira's electric so she can watch her soaps.")
else:
